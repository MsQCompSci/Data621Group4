...
According to our F-statistics, all our models had some effect and the residuals appeared more random throughout, even with some tuning, we couldn't get the $R^2$ to be higher than our first model. We'll use that for our predictions and conclude the assignment by writing those to a csv. 
